...
const Nav = () => {
  ...
  return (
    <nav className="w-full px-36 h-20 flex bg-fabgrey">
      <section className="w-1/3 flex items-center justify-start">
        <Link href="/">
          <a><img src="/logos/FAB-logo.png" alt="FAB Defense Logo" width="100" className="py-6 mr-8" /></a>
        </Link>
      </section>
      <section className="w-1/3 flex items-center justify-center">
        <ul className="flex text-white text-xl font-black space-x-8">
          <Link href="/products">
            <a>
