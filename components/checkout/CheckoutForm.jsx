    ...
    <div className="lg:flex lg:justify-center">
      <div className="leading-loose">
        <form className="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
          <p className="text-gray-800 font-medium">Your Details</p>
          <div className="mt-2">
          ...
          <div className="mt-4">
            <button className="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit">Order Now</button>
          </div>
        </form>
      </div>
    </div>
