...
const CategoryFilter = (props) => {
  ...
  return (
    <div className="mt-4 bg-fabred text-white p-4 rounded-r-lg lg:p-0 lg:bg-white lg:text-black lg:my-16">
      <h4 className="lg:p-2 lg:border-b-2 lg:border-r-2 lg:font-bold lg:text-xl">Filter By</h4>
